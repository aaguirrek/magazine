...
def get_context(context):
	...
	posts = frappe.db.get_all(doctype="Blog Post",fields=["route","title","meta_image","blog_intro","published_on","blogger","blog_category"],filters=[["published","=",1],["meta_image","!=","" ],["blog_category", "=", frappe.form_dict.category ]], order_by="modified desc")
